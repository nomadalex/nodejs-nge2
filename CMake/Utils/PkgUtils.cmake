...
macro(findpkg_finish PREFIX)
  ...
  if (NOT ${PREFIX}_FOUND)
    if (${PREFIX}_INCLUDE_DIR AND ${PREFIX}_LIBRARY)
	  ...
	  if(${PREFIX}_HEADER_ONLY AND ${PREFIX}_INCLUDE_DIR)
		set(${PREFIX}_FOUND TRUE)
		set(${PREFIX}_INCLUDE_DIRS ${${PREFIX}_INCLUDE_DIR})
		if (NOT ${PREFIX}_FIND_QUIETLY)
          message(STATUS "Found ${PREFIX} include: ${${PREFIX}_INCLUDE_DIRS}")
		endif ()
...
macro(define_find_pkg PKG)
  ...
  cmake_parse_arguments(${PKG}_ARG "${options}" "${oneValueArgs}" "${multiValueArgs}" ${ARGN})

  if(${PKG}_ARG_HEADER_ONLY)
	set(${PKG}_HEADER_ONLY true)
  endif()

  prepare_find_pkg_vars(${PKG})

  if(NOT ${PKG}_HEADER_ONLY)
