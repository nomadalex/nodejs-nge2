...
app.init = function(end){
  ...
  nge2.audioLoadAsync(audios[0], "res/music/simple1.mp3", function(err, ret) {
    nge2.audioLoadAsync(audios[1], "res/music/simple3.wav", function(err, ret) {
      nge2.audioLoadAsync(audios[2], "res/music/test.ogg", function(err, ret) {
