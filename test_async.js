...
app.init = function(end){
  ...
  nge2.image_load_async("res/images/demo0.jpg", dtype, 1, function(err, img) {
    if (!img)
      console.log("can not find demo0.jpg!");
    bg = img;
    nge2.image_load_async("res/images/nge2logo.png", nge2.DISPLAY_PIXEL_FORMAT_4444, 1, function(err, img) {
      if (!img)
